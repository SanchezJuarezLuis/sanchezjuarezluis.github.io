...
<br>
      ...
      <ul class="tabs">
        <li class="tab col s3 xl3"><a href="#formula2">Test 1</a></li>
        <li class="tab col s3 xl3"><a href="#map">Test 2</a></li>
        <li class="tab col s3 xl3"><a href="#twt">Test 4</a></li>
      </ul>
    </div>
...
if(arro[i].latitud!=null&arro[i].longitud!=null){
        initMap( arro[i].latitud, arro[i].longitud,arro[i].text);
